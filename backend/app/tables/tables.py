...
from sqlalchemy import String, Integer, ForeignKey, Boolean, Numeric, Date, Time, CheckConstraint
...
class Espacio(Base):
    ...
    precio_hora_parcial: Mapped[Optional[float]] = mapped_column(Numeric(10, 2), CheckConstraint("precio_hora_parcial > 0"))
